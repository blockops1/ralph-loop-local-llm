...
def score_signal(
    ...
    if list_type == 'smart_money' and nf_24h <= 0 and nf_7d <= 0:
    ...
    traders = sm_netflow.get('trader_count', sm_netflow.get('sm_trader_count', 0))
    ...
    # Only applicable for smart_money list type; 0 for other types
    # (traders already fetched at line 65 for the hard disqualifier)
